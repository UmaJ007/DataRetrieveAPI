package com.example.dataretriveapi;
...
import com.example.dataretriveapi.utils.NetworkUtils;
...
//            String cityName = cityEd.getText().toString();
//            getData(cityName);
...
//        Uri uri = Uri.parse("https://datausa.io/api/data?drilldowns=State&measures=Population&year=latest").buildUpon().build();
        Uri uri = Uri.parse("https://raw.githubusercontent.com/UmaJ007/StatesAPI/main/States.json").buildUpon().build();
